...
export default function SignupPage() {
    ...
    const [step, setStep] = useState(1); // step 1: Email/Password, step 2: Biometrics
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="w-full text-pacewell-dark hover:text-pacewell-darker font-semibold py-2"
                    >
                        Back
                    </button>
                </form>
