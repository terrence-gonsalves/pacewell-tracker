                                  ...
                                  <div className="space-y-4">
                                    <div className="pb-4 border-b border-gray-200 last:border-b-0">
                                      ...
                                      >
                                          ...
                                          <h3 style={{ fontSize: '18px', fontWeight: 'bold', color: '#2D6A4F', marginBottom: '12px' }}>Quick Tip</h3>
                                          <p style={{ fontSize: '14px', color: '#2D6A4F', marginBottom: '24px' }}>Logging consistently helps you track progress and stay motivated. Keep it up!</p>
                                    </div>
                                </div>
                            </div>
                        </>
